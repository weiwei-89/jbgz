...
//        sb.append("applyFunc(2,5,sub);").append("\n");
        ...
        String test5 = fileReader.read("D:\\edward\\test\\jbgz\\test\\src\\testCallStatement-test5.txt");
        String test6 = fileReader.read("D:\\edward\\test\\jbgz\\test\\src\\testCallStatement-test6.txt");
        String test7 = fileReader.read("D:\\edward\\test\\jbgz\\test\\src\\testCallStatement-test7.txt");
        Lexer lexer = new Lexer(test7);
        Parser parser = new Parser(lexer);
        Program program = parser.parseProgram();
        Evaluator evaluator = new Evaluator();
        Environment env = new Environment();
