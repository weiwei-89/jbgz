...
import cn.tj.food.sauce.decoder.model.Value;
import cn.tj.food.sauce.xml.model.property.Property;
...
public class Decode extends Element {
    ...
    private void process(String value0, Value out) throws Exception {
        if(this.process == Process.EQUATION) {
        ...
        } else if(this.process == Process.OPTION) {
